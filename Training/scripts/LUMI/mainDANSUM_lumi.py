...
def main():
    ...
    # loading the metric for evaluation
    metric = load("rouge")
    
    # loading the prepared dataset
    dataset = dataprep(data_source)

    # using the AutoTokenizer to tokenize the data for the model
    ...
    # loading the model checkpoint used for fine-tuning
    ...
    print('data_collator')
    # data collator used for the model
    data_collator = DataCollatorForSeq2Seq(tokenizer, model=model)
    
    print('compute_metrics')
    # function to compute metrics used for evaluation
    def compute_metrics(eval_pred):
        predictions, labels = eval_pred
        
        # decoding all the predictions from tokenized form
        ...
        # add mean generated length of tokens
